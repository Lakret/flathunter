...
logging.basicConfig(filename="log.txt", format=format, filemode="w", datefmt="%Y/%m/%d %H:%M:%S", level=logging.DEBUG)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Searches for flats on Immobilienscout24.de and wg-gesucht.de and "
